# Adobe Commerce PHP Developer Documentation

This repository is used to store the code for the [PHP Developer documentation](https://developer.adobe.com/commerce/php/) website. It is built using the [Adobe Edge Delivery Services](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/edge-delivery/overview) and deployed to [Adobe Developer](https://developer.adobe.com/commerce/php/).

This site contains the latest Adobe Commerce and Magento Open Source PHP developer documentation.
...
Once all three servers are running, navigate to `http://localhost:3000/commerce/php`
