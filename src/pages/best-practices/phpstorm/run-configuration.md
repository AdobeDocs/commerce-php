...
![UCT run configuration step 1](../../images/best-practices/phpstorm/uct-run-configuration-1-min.gif)
...
![UCT run configuration template position](../../images/best-practices/phpstorm/uct-run-configuration-template-position.png)

These are the main components of the Upgrade Compatibility Tool Run Configuration template:

![UCT run configuration template view](../../images/best-practices/phpstorm/uct-run-configuration-template-view.png)
...
![UCT run configuration step 3](../../images/best-practices/phpstorm/uct-run-configuration-3-min.gif)
