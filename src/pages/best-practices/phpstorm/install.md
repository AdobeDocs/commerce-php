...
*  Or alternatively, you can install it from your PHPStorm screen. Navigate to **Preferences** > **Plugins** and select Magento PHPStorm.
   ...
   ![Install through PhpStorm](../../images/best-practices/phpstorm/install-through-phpstorm.png)
...
![Enable Magento integration](../../images/best-practices/phpstorm/enable-magento-integration.png)

See the video tutorial [Using the Upgrade Compatibility Tool on PHP Storm](https://experienceleague.adobe.com/en/docs/commerce-learn/tutorials/extensibility/backend-development/upgrade/uct-phpstorm) page for more information about the PHPStorm plugin.
