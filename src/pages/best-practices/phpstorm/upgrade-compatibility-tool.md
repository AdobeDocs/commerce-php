...
![UCT inspections settings](../../images/best-practices/phpstorm/built-in-uct/uct-inspections-settings.png)
...
![UCT inspections highlighting](../../images/best-practices/phpstorm/built-in-uct/uct-inspections-highlighting.png)
![UCT inspections highlighting 2](../../images/best-practices/phpstorm/built-in-uct/uct-inspections-highlighting-2.png)
![UCT inspections highlighting 3](../../images/best-practices/phpstorm/built-in-uct/uct-inspections-highlighting-3.png)
![UCT inspections highlighting 4](../../images/best-practices/phpstorm/built-in-uct/uct-inspections-highlighting-4.png)
...
![Run inspect code from context menu](../../images/best-practices/phpstorm/built-in-uct/run-inspect-code-from-context-menu.png)
...
![UCT IntelliJ IDEA based analysis configuration](../../images/best-practices/phpstorm/built-in-uct/uct-intellij-idea-based-analysis-configuration.png)
...
![UCT inspections profile](../../images/best-practices/phpstorm/built-in-uct/uct-inspections-profile.png)
...
![UCT analysis through IntelliJ IDEA inspect code action](../../images/best-practices/phpstorm/built-in-uct/uct-analysis-through-intellj-idea-inspect-code-action.png)
...
![UCT settings](../../images/best-practices/phpstorm/built-in-uct/uct-settings.png)

After this, you can run this tool at any time you require by using `Tools -> Run The Upgrade Compatibility Tool`:

![Run the built-in UCT](../../images/best-practices/phpstorm/built-in-uct/run-the-built-in-uct-min.gif)
...
![Shared configurations for all inspection types](../../images/best-practices/phpstorm/built-in-uct/shared-configurations-for-all-inspection-types.png)
