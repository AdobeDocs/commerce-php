...
If a module is self-contained, then you can modify or replace it without affecting other areas of the code. This *loose coupling* of software components reduces the ripple effects throughout your code base of changing code.
 ...
 See the [PHP Developer Guide](/development/index.md) for detailed instructions on how to create modules.
...
See [PHP Developer Guide](/development/index.md) for information about using attributes.
...
Service contracts are discussed throughout the documentation set. See [Service layer](../layers/service.md) for a high-level introduction. See [PHP Developer Guide](/development/index.md) for a more detailed discussion of service contracts and dependency injection.
...
See [PHP Developer Guide](/development/index.md) for information on both dependency injection and service contracts.
...
See [Plug-ins](/development/components/plugins.md) in [PHP Developer Guide](/development/index.md) for information on declaring and prioritizing plug-ins.
