...
# Magento_SampleData module

This module includes a sample store, complete with more than 250 products (about 200 of them are configurable products), categories, promotional price rules, CMS pages, banners, and so on. Sample data uses the Luma theme on the storefront.
...
1. To update the dependencies, in the Magento root directory, run:
...
You can find the more detailed description of sample data manipulation procedures at [Sample Data](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/next-steps/sample-data/overview).
