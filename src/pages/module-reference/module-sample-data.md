...
You can find the more detailed description of sample data manipulation procedures at [https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/next-steps/sample-data/overview](https://experienceleague.adobe.com/en/docs/commerce-operations/installation-guide/next-steps/sample-data/overview).
