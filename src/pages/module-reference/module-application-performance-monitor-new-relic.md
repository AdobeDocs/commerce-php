...
For general New Relic PHP configuration information, see [New Relic PHP configuration](https://docs.newrelic.com/docs/apm/agents/php-agent/configuration/php-agent-configuration/).
