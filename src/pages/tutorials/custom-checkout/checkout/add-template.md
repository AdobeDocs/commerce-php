...
[Set Magento to the developer mode](https://devdocs.magento.com/guides/v2.4/config-guide/cli/config-cli-subcommands-mode.html) when performing all customizations and debugging.
