...
For example, SRI hashes for the `adminhtml/Magento/backend/en_US/requirejs/require.js` file will be located in the `pub/static/adminhtml/Magento/backend/en_US/sri-hashes.json` file.
