...
![Payment Gateway Interaction](../../../images/pg-interaction-flow.png)
...
| Payload | Data used for a transaction. Might include: Payment details, order items, shipping and billing addresses, customer details, taxes, merchant's payment provider API credentials. |
